...
import 'package:firebase_socialapp/shared/component/constant.dart';
...
import 'modules/register/social_register_screen.dart';
import 'shared/bloc_observer.dart';
import 'shared/style/theme.dart';

Future<void> firebaseMessagingBackgroundHandler(RemoteMessage message) async {
  showToast(message: 'Background message', color: Colors.green);
}
...
Future<void> main() async {
  ...
  FirebaseMessaging.onMessage.listen((event) {
    ...
    showToast(message: 'on message ', color: Colors.green);
  });
  FirebaseMessaging.onMessageOpenedApp.listen((event) {
    print(event.data.toString());

    showToast(message: 'on message openedApp', color: Colors.green);
  });
  ...
  print("UserID = $uid");
  //print("UserID2 = ${SocialCubit.get(context).userData!.uid}");
